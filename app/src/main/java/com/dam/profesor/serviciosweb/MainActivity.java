    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.insertar:
                ...
                hiloconexion = new ObtenerWebService();
                hiloconexion.execute(INSERT,"3",eNombre.getText().toString(),ePass.getText().toString());   // Parámetros que recibe doInBackground
            ...
            case R.id.actualizar:
                ...
                hiloconexion = new ObtenerWebService();
                hiloconexion.execute(UPDATE,"4",eID.getText().toString(),eNombre.getText().toString(),ePass.getText().toString());   // Parámetros que recibe doInBackground
            ...
            case R.id.borrar:
                ...
                hiloconexion = new ObtenerWebService();
                hiloconexion.execute(DELETE,"5",eID.getText().toString());   // Parámetros que recibe doInBackground
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK){
                        ...
                        if (resultJSON=="1"){      // hay un alumno que mostrar
                            devuelve = devuelve + respuestaJSON.getJSONObject("Usuario").getString("ID") + " " +
                                    ...
                                    respuestaJSON.getJSONObject("Usuario").getString("Password");
